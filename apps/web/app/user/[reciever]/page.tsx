      ...
      <div className="w-screen h-screen overflow-hidden flex">
        ...
        <main className="h-full flex-1 bg-[url('/background2.png')] bg-cover bg-center flex flex-col">
          ...
          <header className="h-16 bg-[color:var(--background)] border-b border-[color:var(--border)] px-4 flex items-center">
            <div className="inline-flex items-center px-2 py-1 h-12 rounded-xl bg-[color:var(--background)] border border-[color:var(--border)]">
              <div
          ...
          <div
            className="flex-1 flex px-3 py-16 h-[70vh]"
            style={
              {
          ...
          >
            <div
              ref={scrollRef}
              className="w-full max-w-3xl mx-auto h-[68vh] overflow-y-auto no-scrollbar p-3 flex flex-col-reverse gap-2"
              role="log"
              aria-live="polite"
          ...
          <div className="w-full flex justify-center px-3 pb-[max(1.5rem,env(safe-area-inset-bottom))] mt-4">
            <div
              ...
              <button
                ...
                className={[
                  ...
                  inputRef.current && inputRef.current.value?.trim()
                    ...
                    : "text-[color:var(--muted-foreground)] cursor-not-allowed",
                ].join(" ")}
